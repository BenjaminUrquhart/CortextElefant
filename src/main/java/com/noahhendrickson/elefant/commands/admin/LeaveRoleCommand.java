 ...
 */
public class LeaveRoleCommand implements ICommand {
        ...
        if (bundle.hasArgs()) {
            ...
            if (role != null) {
                ...
                if (roles.contains(role.getIdLong())) {
                    bundle.getGuild().removeRoleFromMember(bundle.getMember(), role).queue(r ->
    ...
    public String getDescription() {
        return "Removes a role from the calling user.";
    }
